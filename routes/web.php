...
Route::get('javascript/lesson14','javascriptController@lesson14')->name('lesson14');
Route::get('javascript/lesson15','javascriptController@lesson15')->name('lesson15');
Route::get('javascript/lesson16','javascriptController@lesson16')->name('lesson16');
Route::get('javascript/lesson17','javascriptController@lesson17')->name('lesson17');
Route::get('javascript/lesson18','javascriptController@lesson18')->name('lesson18');
...
Route::get('javascript/lesson24','javascriptController@lesson24')->name('lesson24');
Route::get('javascript/lesson25','javascriptController@lesson25')->name('lesson25');

Route::get('ruten/index', 'RutenController@home')->name('RutenHome');
/*GET – 取得資源
POST – 新增一筆資源
PUT – 更新一筆資源
Patch – 更新一筆資源的部分內容
